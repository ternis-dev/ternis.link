...
class StatsTest extends TestCase
{
    ...
    {
        foreach (['http://ternis.link/stats', 'http://ternis.link/stats/domains', 'http://ternis.link/stats/links'] as $url) {
    ...
    {
        $this->get('http://href.nz/stats')->assertNotFound();
        $this->get('http://dash.ternis.link/stats')->assertNotFound();
        $this->get('http://admin.ternis.link/stats')->assertNotFound();
    }
}
