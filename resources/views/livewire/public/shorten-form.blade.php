<div class="nz-form">
    {{-- 28 · form sparkle --}}
    <svg class="dz dz-faint" style="top: -14px; left: 12px; transform: rotate(-12deg);" width="22" height="22" viewBox="0 0 32 32" fill="none" aria-hidden="true"><path d="M16 3 Q 17 13, 27 15 Q 17 17, 16 27 Q 15 17, 5 15 Q 15 13, 16 3" stroke="currentColor" stroke-width="2.2" stroke-linejoin="round"/></svg>
    {{-- 29 · form sparkle --}}
    <svg class="dz dz-faint" style="top: -8px; right: 30px; transform: rotate(14deg);" width="16" height="16" viewBox="0 0 32 32" fill="none" aria-hidden="true"><path d="M16 3 Q 17 13, 27 15 Q 17 17, 16 27 Q 15 17, 5 15 Q 15 13, 16 3" stroke="currentColor" stroke-width="2.4" stroke-linejoin="round"/></svg>
    <h2 class="nz-form-title">
        {{-- 30 · chain link --}}
        <svg style="display:inline-block; vertical-align: -3px;" width="22" height="22" viewBox="0 0 32 32" fill="none" aria-hidden="true"><path d="M13 19 L19 13 M15 8 L18 5 a5.5 5.5 0 0 1 8 8 l-3 3 M17 24 l-3 3 a5.5 5.5 0 0 1-8-8 l3-3" stroke="currentColor" stroke-width="2.6" stroke-linecap="round"/></svg>
    ...
    @if ($shortUrl)
        <div class="nz-result" role="status" aria-live="polite">
            {{-- 31 · result burst --}}
            <svg class="nz-result-burst" width="44" height="44" viewBox="0 0 48 48" fill="none" aria-hidden="true"><path d="M24 3 L27 17 L41 12 L31 23 L45 28 L30 30 L34 44 L24 33 L14 44 L18 30 L3 28 L17 23 L7 12 L21 17 Z" stroke="currentColor" stroke-width="2.4" stroke-linejoin="round"/></svg>
